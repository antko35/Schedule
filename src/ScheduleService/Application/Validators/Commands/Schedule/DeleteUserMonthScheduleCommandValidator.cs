...
{
    public sealed class DeleteUserMonthScheduleCommandValidator
        : AbstractValidator<DeleteUserMonthScheduleCommand>
    {
        public DeleteUserMonthScheduleCommandValidator()
        {
